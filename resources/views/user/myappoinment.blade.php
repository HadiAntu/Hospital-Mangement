      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{url('home')}}/#contact">About Us</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{url('home')}}/#doctor">Doctors</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{url('home')}}/#nwes">News</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{url('home')}}/#appoinment">Contact</a>
            </li>
   ...
   <div align="center" style="padding:70px;">
       <table style="border: 1px solid white;">
           ...
           <tr style="border: 5px " align="center">
               ...
               <td class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this')"><a href="{{url('cancelappoinment',$appoints->id)}}">Cancel</a></td>
